...
A selecao de autor, metadados e logica de catalogo sao definidos pela skill chamadora (`radar-writer.md` para fluxo automatizado a partir da queue, `instrumento.md` para fluxo manual com input direto). Este ficheiro e lido por ambas antes da escrita do HTML.
